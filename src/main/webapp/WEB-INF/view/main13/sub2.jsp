...
<%-- #1. 여러곳에서 반복해서 쓰는 주소 --%>
<%-- #2. request parameter를 추가 --%>
<%-- #3. request parameter 의 url encoding --%>
...
<a href="https://search.search.com/search.naver?query=뉴진스&where=nexearch&sm=top_hty&fbm=0&ie=utf8">네이버 검색</a>
