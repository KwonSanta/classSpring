...
public class Controller14 {
    ...
    @RequestMapping("sub5")
    public String sub5(MyBean142 o1) { // MyBean142는 ModelAttribute 이다.
    ...
    // /main14/sub9?name=강인&age=24&address=파리
    // sub9의 하는 일을 아래처럼 생략해서 사용가능하다.
    ...
    public void sub12(
            Integer price, // @RequestParam 생략됨
            String car, // @RequestParam 생략됨
            MyBean147 o1, // @ModelAttribute 생량됨
            MyBean146 o2) { // @ModelAttribute 생량됨
